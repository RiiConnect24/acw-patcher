...
wbmgt patch accf-data/DATA/files/Script/ENG/NPC_SP/NPC_gatekeeperA.bmg --patch replace=BMG/%region%/English/NPC_gatekeeperA.txt
wbmgt patch accf-data/DATA/files/Script/ENG/NPC_SP/NPC_gatekeeperB.bmg --patch replace=BMG/%region%/English/NPC_gatekeeperB.txt
wbmgt patch accf-data/DATA/files/Script/ENG/SYS_mess/SYS_NetworkError.bmg --patch replace=BMG/%region%/English/SYS_NetworkError.txt
echo Done.
